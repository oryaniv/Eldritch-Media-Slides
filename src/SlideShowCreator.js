...
(function (EldritchSlideShow) {
    EldritchSlideShow.configOptions = { scriptPath: "", stylePath: "" };
    ...
    EldritchSlideShow.Create = function (param1, param2) {
        ...
        frame.contentWindow.document.write(stylesheet + animatecss + fonts + rangeSliderCss + content + jquery + flowType + howler + animationRepository + SlidShowscript + insertObj + rangeSliderjs + CustomScript);
    ...
    var insertSdObject = function (sd) {
