...
(function (EldritchSlideShow) {
    ...
    var SlideShowRemote = (function () {
        function SlideShowRemote(sd, frame) {
            var _this = this;
            this.runWhenReady = function (methodName, param) {
                var frameWindow = _this.targetFrame.contentWindow;
                if (frameWindow.document.readyState === "complete") {
                    frameWindow[methodName](param);
                }
                else {
            ...
            this.Start = function () {
                ...
                if (frameWindow.document.readyState === "complete") {
                    ...
                    frameWindow.addEventListener("load", function () {
                        setTimeout(function () { return frameWindow["Play"](); }, 1000);
                    }, false);
                }
                return _this;
            };
            ...
            this.AddImages = function (images) {
                ...
                _this.runWhenReady("AddImages", images);
                return _this;
            };
            this.AddSlides = function (slides) {
                ...
                _this.runWhenReady("AddSlides", slides);
                return _this;
            };
            this.AddSlideTexts = function (texts) {
                ...
                _this.runWhenReady("AddSlideTexts", texts);
                return _this;
            };
            this.AddBackGrounds = function (backGrounds) {
                ...
                _this.runWhenReady("AddBackGrounds", backGrounds);
                return _this;
            };
            this.SetAnimationLevel = function (level) {
                ...
                _this.runWhenReady("SetAnimationLevel", level);
                return _this;
            };
            this.SetFilters = function (level) {
                ...
                _this.runWhenReady("SetFilters", level);
                return _this;
            };
            this.SetTextStyles = function (level) {
                ...
                _this.runWhenReady("SetTextStyles", level);
                return _this;
            };
            this.SetTextAnimes = function (level) {
                ...
                _this.runWhenReady("SetTextAnimes", level);
                return _this;
            };
            ...
            this.SetAudio = function (audio) {
                ...
                _this.runWhenReady("SetAudio", audio);
                return _this;
            };
            this.SetVolume = function (volume) {
                ...
                //this.runWhenReady("SetVolume", volume);
                var frameWindow = _this.targetFrame.contentWindow;
                if (frameWindow.document.readyState === "complete") {
                    frameWindow["SetVolume"](volume);
                }
                else {
                    frameWindow.document.addEventListener("DOMContentLoaded", function () {
                        setTimeout(function () {
            ...
            this.SetCallBack = function (CallBackObject) {
                ...
                _this.runWhenReady("SetCallBack", CallBackObject);
                return _this;
            };
            this.SetLoop = function (loop) {
                ...
                _this.runWhenReady("SetLoop", loop);
                return _this;
            };
            this.SetBackgroundBetween = function (showBackground) {
                ...
                _this.runWhenReady("SetBackgroundBetween", showBackground);
                return _this;
            };
